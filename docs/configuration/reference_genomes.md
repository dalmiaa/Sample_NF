# dalmiaa/Sample_NF: Reference Genomes Configuration

The dalmiaa/Sample_NF pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```nextflow
includeConfig '/path/to/dalmiaa/Sample_NF/conf/igenomes.config'
```
